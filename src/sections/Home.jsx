      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              Passionate Java Backend and Android Developer focused on
              building scalable applications, efficient APIs, and
              user-friendly digital experiences. I enjoy solving
              real-world problems through clean code, modern
