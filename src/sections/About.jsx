        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-2 text-lg sm:text-xl text-white/90 font-semibold">
              Java Backend Developer & Android App Developer
            </p>
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
              I specialize in Java backend development, Android application
              development, and database-driven systems. My technical skill set
              includes Java, Spring Boot, Android SDK, SQL, MySQL, Python,
              C++, Git, REST APIs, and software architecture principles.
            </p>

            <p className="mt-4 text-gray-400 text-base sm:text-lg">
              I am constantly exploring new technologies and best practices to
              build scalable, reliable, and impactful software solutions.
              Whether it's developing efficient backend services or crafting
              intuitive Android experiences, I enjoy solving real-world
