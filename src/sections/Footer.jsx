...
const Footer = () => {
return ( <footer className="relative overflow-hidden bg-black"> <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(55%_60%_at_70%_35%,rgba(13,88,204,0.35),transparent_70%)]" />
...
```
  ...
  >
    ...
    <p className="text-gray-300 italic max-w-xl">
      Building scalable software solutions, solving real-world
      problems, and continuously learning new technologies.
    </p>

    <p className="text-xs text-gray-400">
      © {new Date().getFullYear()} Priyansh Kushwaha.
      All rights reserved.
    </p>
  </motion.div>
</footer>
