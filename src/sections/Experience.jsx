...
const experiences = [
  {
    role: "Integrated M.Tech in Information Technology",
    company: "IIPS DAVV, Indore",
    duration: "2022 - 2027",
    description:
      "Currently pursuing Integrated M.Tech in Information Technology with coursework in Data Structures & Algorithms, DBMS, Operating Systems, Computer Networks, and Software Engineering.",
  },

  {
    role: "Vice President",
    company: "DAVV University (ABVP)",
    duration: "2024 - Present",
    description:
      "Representing student concerns, coordinating with university administration, and leading initiatives focused on student engagement, leadership, and campus development.",
  },

  {
    role: "Head Coordinator",
    company: "TEDxDAVV Indore",
    duration: "2025 - Present",
    description:
      "Leading planning and execution of TEDxDAVV events, managing speaker coordination, logistics, volunteer teams, and ensuring successful delivery of large-scale events.",
  },

  {
    role: "Full Stack Developer",
    company: "CampusNest Roommate Finder",
    duration: "Major Project",
    description:
      "Developed a student housing platform using React.js, Spring Boot, and PostgreSQL featuring secure authentication, roommate matching, property verification, and RESTful APIs.",
  },

  {
    role: "Java Developer",
    company: "Digital Steganography",
    duration: "Academic Project",
    description:
      "Built a desktop application using Java, JavaFX, and AES Encryption to securely hide and extract messages within digital images using steganography techniques.",
  },

  {
    role: "Frontend Developer",
    company: "Digital Library",
    duration: "Academic Project",
    description:
      "Developed a responsive Digital Library platform using React.js and Vite with reusable components and modern frontend development practices.",
  },
];
      ...
      <div ref={sceneRef} style={{ height: `${SCENE_HEIGHT_VH}vh`, minHeight: "120vh" }} className="relative">
        <div className="sticky top-0 h-screen flex flex-col">
          ...
          <div className="shrink-0 px-6 pt-8">
            <h2 className="text-4xl sm:text-5xl font-semibold mt-5 text-center">Education & Leadership Journey</h2>
          </div>
          {/* Timeline container */}
